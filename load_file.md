...
![](screenshots/login/step_2-choose_file.png)  
  
Najděte ve svém počítači umístění souboru typu `vmk`
> Poznáte tak, že název souboru končí jako `.vmk`

![](screenshots/login/step_3-chosen_file.png) 

Klikněte na tlačítko `Pokračovat`  

![](screenshots/login/step_4-continue.png) 

Na další obrazovce uvidíte obsah VMK souboru (snímky)  

![](screenshots/login/step_5-dicom_overview.png)
